...
type CreatePalmPayTransactionRequest struct {
	...
	// 该模板ID是商户在向微信支付提权限申请时由微信支付生成
	PlanId *string `json:"plan_id"`
	// 用户在商户AppID下的唯一标识。
	Openid *string `json:"openid"`
	// 接受扣款结果异步回调通知的URL，注意回调URL只接受HTTPS
	NotifyUrl *string `json:"notify_url"`
	// 交易场景值，目前支持 ：PALM_METRO—刷掌地铁；
	TradeScene *PalmPayTradeScene `json:"trade_scene"`
	// 请求受理扣费 tradescene为PALM_METRO时，传入该参数
	MetroInfo *PalmMetroSceneInfo `json:"metro_info,omitempty"`
	// 订单金额
	Amount *OrderAmount `json:"amount"`
}

func (o CreatePalmPayTransactionRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.Appid == nil {
		return nil, fmt.Errorf("field `Appid` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	toSerialize["appid"] = o.Appid

	if o.Description == nil {
		return nil, fmt.Errorf("field `Description` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	...
	if o.OutTradeNo == nil {
		return nil, fmt.Errorf("field `OutTradeNo` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	...
	if o.PlanId == nil {
		return nil, fmt.Errorf("field `PlanId` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	toSerialize["plan_id"] = o.PlanId

	if o.Openid == nil {
		return nil, fmt.Errorf("field `Openid` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	toSerialize["openid"] = o.Openid

	if o.NotifyUrl == nil {
		return nil, fmt.Errorf("field `NotifyUrl` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	toSerialize["notify_url"] = o.NotifyUrl

	if o.TradeScene == nil {
		return nil, fmt.Errorf("field `TradeScene` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	...
	if o.Amount == nil {
		return nil, fmt.Errorf("field `Amount` is required and must be specified in CreatePalmPayTransactionRequest")
	}
	toSerialize["amount"] = o.Amount
	return json.Marshal(toSerialize)
}

func (o CreatePalmPayTransactionRequest) String() string {
	var ret string
	if o.Appid == nil {
		ret += "Appid:<nil>, "
	} else {
	...
	return fmt.Sprintf("CreatePalmPayTransactionRequest{%s}", ret)
}

func (o CreatePalmPayTransactionRequest) Clone() *CreatePalmPayTransactionRequest {
	ret := CreatePalmPayTransactionRequest{}
	...
	if o.TradeScene != nil {
		ret.TradeScene = new(PalmPayTradeScene)
...
// PalmMetroSceneInfo
type PalmMetroSceneInfo struct {
	// 用户乘车时间（上车），按照使用rfc3339所定义的格式，格式为yyyy-MM-DDThh:mm:ss+TIMEZONE
	StartTime *string `json:"start_time"`
	// 用户下车时间，按照使用rfc3339所定义的格式，格式为yyyy-MM-DDThh:mm:ss+TIMEZONE
	EndTime *string `json:"end_time,omitempty"`
	...
	// 乘车终点站，该值催缴时会向微信用户进行展示
	EndStation *string `json:"end_station,omitempty"`
	// 由刷掌终端设备生成的刷掌扣款凭证，扣费时会对刷掌扣款凭证进行校验
	DeductCredential *string `json:"deduct_credential"`
}

func (o PalmMetroSceneInfo) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StartTime == nil {
		return nil, fmt.Errorf("field `StartTime` is required and must be specified in PalmMetroSceneInfo")
	}
	toSerialize["start_time"] = o.StartTime
	...
	if o.DeductCredential == nil {
		return nil, fmt.Errorf("field `DeductCredential` is required and must be specified in PalmMetroSceneInfo")
	}
	toSerialize["deduct_credential"] = o.DeductCredential
	return json.Marshal(toSerialize)
}

func (o PalmMetroSceneInfo) String() string {
	var ret string
	if o.StartTime == nil {
		ret += "StartTime:<nil>, "
	} else {
	...
	if o.DeductCredential == nil {
		ret += "DeductCredential:<nil>"
	} else {
		ret += fmt.Sprintf("DeductCredential:%v", *o.DeductCredential)
	}

	return fmt.Sprintf("PalmMetroSceneInfo{%s}", ret)
}

func (o PalmMetroSceneInfo) Clone() *PalmMetroSceneInfo {
	ret := PalmMetroSceneInfo{}
	...
	if o.DeductCredential != nil {
		ret.DeductCredential = new(string)
		*ret.DeductCredential = *o.DeductCredential
	}
...
// PalmPayTradeScene
type PalmPayTradeScene string

func (e PalmPayTradeScene) Ptr() *PalmPayTradeScene {
	return &e
}

// Enums of PalmPayTradeScene
const (
	PALMPAYTRADESCENE_PALM_METRO PalmPayTradeScene = "PALM_METRO"
)

// PalmPayTransaction 刷掌直连商户的订单结构
type PalmPayTransaction struct {
	// 商户在微信申请公众号或移动应用成功后分配的账号ID，登录平台为mp.weixin.qq.com或open.weixin.qq.com
	Appid *string `json:"appid"`
	// 微信支付分配的商户号
	...
	// 交易状态，枚举值：SUCCESS—支付成功 ACCEPT—已接收，等待扣款 PAY_FAIL--支付失败(其他原因，如银行返回失败) REFUND—转入退款
	...
	// 该字段标识对应的垫资单是否已还款或者已撤销。注意，使用此字段前需先确认bank_type字段值为BPA 以及 trade_state字段值为SUCCESS或者REFUND。枚举值如下：NOT_REPAY—用户未还款，REPAID—用户已还款，ALL_REFUND—由于全额退款，无需还款
	...
	Attach *string `json:"attach,omitempty"`
	// 交易场景值，目前支持 ：PALM_METRO—刷掌地铁；
	TradeScene *PalmPayTradeScene `json:"trade_scene,omitempty"`
	// 返回信息中的trade_scene为PALM_METRO，返回该场景信息
	MetroInfo *PalmMetroSceneInfo `json:"metro_info,omitempty"`
	// 订单金额信息
...
func (o PalmPayTransaction) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.Appid == nil {
		return nil, fmt.Errorf("field `Appid` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["appid"] = o.Appid

	if o.Mchid == nil {
		return nil, fmt.Errorf("field `Mchid` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["mchid"] = o.Mchid

	if o.Description == nil {
		return nil, fmt.Errorf("field `Description` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["description"] = o.Description

	if o.CreateTime == nil {
		return nil, fmt.Errorf("field `CreateTime` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["create_time"] = o.CreateTime

	if o.OutTradeNo == nil {
		return nil, fmt.Errorf("field `OutTradeNo` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["out_trade_no"] = o.OutTradeNo
	...
	if o.TradeState == nil {
		return nil, fmt.Errorf("field `TradeState` is required and must be specified in PalmPayTransaction")
	}
	...
	if o.Amount == nil {
		return nil, fmt.Errorf("field `Amount` is required and must be specified in PalmPayTransaction")
	}
	toSerialize["amount"] = o.Amount
...
func (o PalmPayTransaction) String() string {
	var ret string
	if o.Appid == nil {
		ret += "Appid:<nil>, "
	} else {
	...
	return fmt.Sprintf("PalmPayTransaction{%s}", ret)
}

func (o PalmPayTransaction) Clone() *PalmPayTransaction {
	ret := PalmPayTransaction{}
...
// QueryPalmPayTransactionRequest
type QueryPalmPayTransactionRequest struct {
	// 商户系统内部订单号，只能是数字、大小写字母，且在同一个商户号下唯一。该字段长度限制为字节长度限制
	OutTradeNo *string `json:"out_trade_no"`
}

func (o QueryPalmPayTransactionRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.OutTradeNo == nil {
		return nil, fmt.Errorf("field `OutTradeNo` is required and must be specified in QueryPalmPayTransactionRequest")
	}
	toSerialize["out_trade_no"] = o.OutTradeNo
	return json.Marshal(toSerialize)
}

func (o QueryPalmPayTransactionRequest) String() string {
	var ret string
	if o.OutTradeNo == nil {
		ret += "OutTradeNo:<nil>"
	} else {
	...
	return fmt.Sprintf("QueryPalmPayTransactionRequest{%s}", ret)
}

func (o QueryPalmPayTransactionRequest) Clone() *QueryPalmPayTransactionRequest {
	ret := QueryPalmPayTransactionRequest{}
