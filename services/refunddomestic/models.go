...
func (o Amount) String() string {
	...
	if o.RefundFee == nil {
		...
		ret += fmt.Sprintf("RefundFee:%v", *o.RefundFee)
	}
...
func (o Amount) Clone() *Amount {
	...
	if o.RefundFee != nil {
		ret.RefundFee = new(int64)
		*ret.RefundFee = *o.RefundFee
	}
...
type CreateAbnormalRefundBody struct {
...
func (o CreateAbnormalRefundBody) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
	...
	if o.OutRefundNo == nil {
		return nil, fmt.Errorf("field `OutRefundNo` is required and must be specified in CreateAbnormalRefundBody")
	}
	toSerialize["out_refund_no"] = o.OutRefundNo

	if o.Type == nil {
		return nil, fmt.Errorf("field `Type` is required and must be specified in CreateAbnormalRefundBody")
	}
...
func (o CreateAbnormalRefundBody) String() string {
	var ret string
	if o.SubMchid == nil {
		ret += "SubMchid:<nil>, "
	} else {
	...
	return fmt.Sprintf("CreateAbnormalRefundBody{%s}", ret)
}

func (o CreateAbnormalRefundBody) Clone() *CreateAbnormalRefundBody {
	ret := CreateAbnormalRefundBody{}
...
func (o CreateAbnormalRefundRequest) MarshalJSON() ([]byte, error) {
	...
	if o.RefundId == nil {
		return nil, fmt.Errorf("field `RefundId` is required and must be specified in CreateAbnormalRefundRequest")
	}
...
type CreateRequest struct {
	// 子商户的商户号，由微信支付生成并下发。服务商模式下必须传递此参数
	SubMchid *string `json:"sub_mchid,omitempty"`
	// 原支付交易对应的微信订单号，与out_trade_no二选一
	TransactionId *string `json:"transaction_id,omitempty"`
	// 原支付交易对应的商户订单号，与transaction_id二选一
