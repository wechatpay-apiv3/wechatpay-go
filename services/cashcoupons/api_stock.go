...
// CreateNocashSingleitemStock 创建无资金流单品批次
//
// 创建无资金流单品批次
func (a *StockApiService) CreateNocashSingleitemStock(ctx context.Context, req CreateNocashSingleitemStockRequest) (resp *CreateNocashSingleitemStockResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodPost
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	localVarPath := consts.WechatPayAPIServer + "/v3/marketing/favor/nocash-singleitem-stocks"
	// Make sure All Required Params are properly set
	...
	// Extract CreateNocashSingleitemStockResponse from Http Response
	resp = new(CreateNocashSingleitemStockResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// CreateNocashStock 创建无资金流全场批次
//
// 创建无资金流全场批次
func (a *StockApiService) CreateNocashStock(ctx context.Context, req CreateNocashStockRequest) (resp *CreateNocashStockResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodPost
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	localVarPath := consts.WechatPayAPIServer + "/v3/marketing/favor/nocash-stocks"
	// Make sure All Required Params are properly set
	...
	// Extract CreateNocashStockResponse from Http Response
	resp = new(CreateNocashStockResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// ModifyAvailableMerchants 修改批次可用商户号
//
// 修改批次可用商户号
//
// 前置条件：成功激活代金券批次
//
// 是否支持幂等：是
func (a *StockApiService) ModifyAvailableMerchants(ctx context.Context, req ModifyAvailableMerchantsRequest) (resp *ModifyAvailableMerchantResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodPost
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	// Make sure Path Params are properly set
	if req.StockId == nil {
		return nil, nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyAvailableMerchantsRequest")
	}

	localVarPath := consts.WechatPayAPIServer + "/v3/marketing/favor/stocks/{stock_id}/modify-merchants"
	// Build Path with Path Params
	localVarPath = strings.Replace(localVarPath, "{"+"stock_id"+"}", neturl.PathEscape(core.ParameterToString(*req.StockId, "")), -1)
	...
	// Setup Body Params
	localVarPostBody = &ModifyAvailableMerchantRequest{
		StockCreatorMchid: req.StockCreatorMchid,
		AddMchidList:      req.AddMchidList,
		DeleteMchidList:   req.DeleteMchidList,
	}
	...
	// Extract ModifyAvailableMerchantResponse from Http Response
	resp = new(ModifyAvailableMerchantResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// ModifyAvailableSingleitems 修改可核销商品编码
//
// 修改可核销商品编码
//
// 前置条件：批次已激活且未结束
//
// 是否支持幂等：是
func (a *StockApiService) ModifyAvailableSingleitems(ctx context.Context, req ModifyAvailableSingleitemsRequest) (resp *ModifyAvailableSingleitemResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodPost
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	// Make sure Path Params are properly set
	if req.StockId == nil {
		return nil, nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyAvailableSingleitemsRequest")
	}

	localVarPath := consts.WechatPayAPIServer + "/v3/marketing/favor/stocks/{stock_id}/modify-goods-id"
	// Build Path with Path Params
	localVarPath = strings.Replace(localVarPath, "{"+"stock_id"+"}", neturl.PathEscape(core.ParameterToString(*req.StockId, "")), -1)
	...
	// Setup Body Params
	localVarPostBody = &ModifyAvailableSingleitemRequest{
		StockCreatorMchid: req.StockCreatorMchid,
		AddGoodsIdList:    req.AddGoodsIdList,
		DeleteGoodsIdList: req.DeleteGoodsIdList,
	}
	...
	// Extract ModifyAvailableSingleitemResponse from Http Response
	resp = new(ModifyAvailableSingleitemResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// ModifyBudget 修改批次预算金额
//
// 商户通过这个接口修改代金券批次库存
//
// 接口频率：1000/min
//
// 前置条件：商户开通了代金券产品权限,且批次已激活
//
// 是否支持幂等：是
func (a *StockApiService) ModifyBudget(ctx context.Context, req ModifyBudgetRequest) (resp *ModifyStockBudgetResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodPost
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	localVarPath := consts.WechatPayAPIServer + "/v3/marketing/favor/stocks/{stock_id}/max-amount-modify"
	// Build Path with Path Params
	localVarPath = strings.Replace(localVarPath, "{"+"stock_id"+"}", neturl.PathEscape(core.ParameterToString(*req.StockId, "")), -1)
	...
	// Setup Body Params
	localVarPostBody = &ModifyStockBudgetRequest{
		StockCreatorMchid: req.StockCreatorMchid,
		TargetMaxAmount:   req.TargetMaxAmount,
		CurrentMaxAmount:  req.CurrentMaxAmount,
	}
	...
	// Extract ModifyStockBudgetResponse from Http Response
	resp = new(ModifyStockBudgetResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
//
// 是否支持幂等：是
func (a *StockApiService) ModifyStock(ctx context.Context, req ModifyStockRequest) (resp *ModifyStockResponse, result *core.APIResult, err error) {
	var (
	...
	// Make sure Path Params are properly set
	if req.StockId == nil {
		return nil, nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyStockRequest")
	}
	...
	// Setup Body Params
	localVarPostBody = &ModifyStockBody{
		StockCreatorMchid: req.StockCreatorMchid,
		MaxAmountByDay:    req.MaxAmountByDay,
	}
	...
	// Extract ModifyStockResponse from Http Response
	resp = new(ModifyStockResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// 5. 该接口只能使用创建活动方进行调用”
func (a *StockApiService) RefundFlow(ctx context.Context, req RefundFlowRequest) (resp *StockDownloadRefundFlowResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodGet
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	// Extract StockDownloadRefundFlowResponse from Http Response
	resp = new(StockDownloadRefundFlowResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
...
// 4. 该接口需要活动结束后次日10点才可以下载。
// 5. 该接口只能使用创建活动方进行调用。
func (a *StockApiService) UseFlow(ctx context.Context, req UseFlowRequest) (resp *StockDownloadUseFlowResponse, result *core.APIResult, err error) {
	var (
		localVarHTTPMethod   = nethttp.MethodGet
		localVarPostBody     interface{}
		localVarQueryParams  neturl.Values
	...
	// Extract StockDownloadUseFlowResponse from Http Response
	resp = new(StockDownloadUseFlowResponse)
	err = core.UnMarshalResponse(result.Response, resp)
	if err != nil {
		return nil, result, err
	}
