...
type CreateNocashSingleitemStockRequest struct {
	// 批次名称
	StockName *string `json:"stock_name"`
	// 可核销商户
	...
	// 优惠生效时间（包括立减、券）
	FavorAvailableTime *FavorAvailableTime `json:"favor_available_time"`
	// 代金券说明
	Description *string `json:"description,omitempty"`
	// 可用单品编码列表
	GoodsIdList []string `json:"goods_id_list,omitempty"`
	//
	StockUseRule *StockUseRule `json:"stock_use_rule"`
	// 单品优惠特定信息
	SingleitemFavor *CutTypeMsg `json:"singleitem_favor"`
}

func (o CreateNocashSingleitemStockRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockName == nil {
		return nil, fmt.Errorf("field `StockName` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["stock_name"] = o.StockName
	...
	if o.AvailableBeginTime == nil {
		return nil, fmt.Errorf("field `AvailableBeginTime` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["available_begin_time"] = o.AvailableBeginTime

	if o.AvailableEndTime == nil {
		return nil, fmt.Errorf("field `AvailableEndTime` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["available_end_time"] = o.AvailableEndTime

	if o.NaturalPersonLimit == nil {
		return nil, fmt.Errorf("field `NaturalPersonLimit` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["natural_person_limit"] = o.NaturalPersonLimit

	if o.PreventApiAbuse == nil {
		return nil, fmt.Errorf("field `PreventApiAbuse` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["prevent_api_abuse"] = o.PreventApiAbuse

	if o.FavorAvailableTime == nil {
		return nil, fmt.Errorf("field `FavorAvailableTime` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["favor_available_time"] = o.FavorAvailableTime

	if o.Description != nil {
		toSerialize["description"] = o.Description
	}

	if o.GoodsIdList != nil {
		toSerialize["goods_id_list"] = o.GoodsIdList
	}

	if o.StockUseRule == nil {
		return nil, fmt.Errorf("field `StockUseRule` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["stock_use_rule"] = o.StockUseRule

	if o.SingleitemFavor == nil {
		return nil, fmt.Errorf("field `SingleitemFavor` is required and must be specified in CreateNocashSingleitemStockRequest")
	}
	toSerialize["singleitem_favor"] = o.SingleitemFavor
	return json.Marshal(toSerialize)
}

func (o CreateNocashSingleitemStockRequest) String() string {
	var ret string
	if o.StockName == nil {
		ret += "StockName:<nil>, "
	} else {
	...
	ret += fmt.Sprintf("FavorAvailableTime:%v, ", o.FavorAvailableTime)
	...
	ret += fmt.Sprintf("GoodsIdList:%v, ", o.GoodsIdList)

	ret += fmt.Sprintf("StockUseRule:%v, ", o.StockUseRule)

	ret += fmt.Sprintf("SingleitemFavor:%v", o.SingleitemFavor)

	return fmt.Sprintf("CreateNocashSingleitemStockRequest{%s}", ret)
}

func (o CreateNocashSingleitemStockRequest) Clone() *CreateNocashSingleitemStockRequest {
	ret := CreateNocashSingleitemStockRequest{}
	...
	if o.AvailableMchid != nil {
		ret.AvailableMchid = make([]string, len(o.AvailableMchid))
		for i, item := range o.AvailableMchid {
			ret.AvailableMchid[i] = item
		}
	}
	...
	if o.FavorAvailableTime != nil {
		ret.FavorAvailableTime = o.FavorAvailableTime.Clone()
	}
	...
	if o.GoodsIdList != nil {
		ret.GoodsIdList = make([]string, len(o.GoodsIdList))
		for i, item := range o.GoodsIdList {
			ret.GoodsIdList[i] = item
		}
	}
	...
	if o.SingleitemFavor != nil {
		ret.SingleitemFavor = o.SingleitemFavor.Clone()
	}
...
type CreateNocashSingleitemStockResponse struct {
	// 批次号
	StockId *string `json:"stock_id"`
	// 创建时间
	CreateTime *string `json:"create_time"`
...
func (o CreateNocashSingleitemStockResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in CreateNocashSingleitemStockResponse")
	}
	toSerialize["stock_id"] = o.StockId

	if o.CreateTime == nil {
		return nil, fmt.Errorf("field `CreateTime` is required and must be specified in CreateNocashSingleitemStockResponse")
	}
	toSerialize["create_time"] = o.CreateTime
	return json.Marshal(toSerialize)
}

func (o CreateNocashSingleitemStockResponse) String() string {
	var ret string
	if o.StockId == nil {
		ret += "StockId:<nil>, "
	} else {
	...
	return fmt.Sprintf("CreateNocashSingleitemStockResponse{%s}", ret)
}

func (o CreateNocashSingleitemStockResponse) Clone() *CreateNocashSingleitemStockResponse {
	ret := CreateNocashSingleitemStockResponse{}
...
type CreateNocashStockRequest struct {
	// 批次名称
	StockName *string `json:"stock_name"`
	// 可核销商户
	AvailableMerchants []string `json:"available_merchants,omitempty"`
	...
	// 批次使用规则
	StockUseRule *StockUseRule `json:"stock_use_rule"`
	// NORMAL-代金券批次；DISCOUNT_CUT-立减与折扣；
	StockType *string `json:"stock_type"`
	// 立减与折扣批次特定信息
	DiscountCutMessage *DiscountCutMsg `json:"discount_cut_message"`
}

func (o CreateNocashStockRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockName == nil {
		return nil, fmt.Errorf("field `StockName` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["stock_name"] = o.StockName
	...
	if o.AvailableBeginTime == nil {
		return nil, fmt.Errorf("field `AvailableBeginTime` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["available_begin_time"] = o.AvailableBeginTime

	if o.AvailableEndTime == nil {
		return nil, fmt.Errorf("field `AvailableEndTime` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["available_end_time"] = o.AvailableEndTime

	if o.NaturalPersonLimit == nil {
		return nil, fmt.Errorf("field `NaturalPersonLimit` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["natural_person_limit"] = o.NaturalPersonLimit

	if o.PreventApiAbuse == nil {
		return nil, fmt.Errorf("field `PreventApiAbuse` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["prevent_api_abuse"] = o.PreventApiAbuse

	if o.FavorAvailableTime == nil {
		return nil, fmt.Errorf("field `FavorAvailableTime` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["favor_available_time"] = o.FavorAvailableTime
	...
	if o.StockUseRule == nil {
		return nil, fmt.Errorf("field `StockUseRule` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["stock_use_rule"] = o.StockUseRule

	if o.StockType == nil {
		return nil, fmt.Errorf("field `StockType` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["stock_type"] = o.StockType

	if o.DiscountCutMessage == nil {
		return nil, fmt.Errorf("field `DiscountCutMessage` is required and must be specified in CreateNocashStockRequest")
	}
	toSerialize["discount_cut_message"] = o.DiscountCutMessage
	return json.Marshal(toSerialize)
}

func (o CreateNocashStockRequest) String() string {
	var ret string
	if o.StockName == nil {
		ret += "StockName:<nil>, "
	} else {
	...
	ret += fmt.Sprintf("DiscountCutMessage:%v", o.DiscountCutMessage)

	return fmt.Sprintf("CreateNocashStockRequest{%s}", ret)
}

func (o CreateNocashStockRequest) Clone() *CreateNocashStockRequest {
	ret := CreateNocashStockRequest{}
	...
	if o.DiscountCutMessage != nil {
		ret.DiscountCutMessage = o.DiscountCutMessage.Clone()
	}
...
type CreateNocashStockResponse struct {
	// 批次号
	StockId *string `json:"stock_id"`
	// 创建时间
	CreateTime *string `json:"create_time"`
...
func (o CreateNocashStockResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in CreateNocashStockResponse")
	}
	toSerialize["stock_id"] = o.StockId

	if o.CreateTime == nil {
		return nil, fmt.Errorf("field `CreateTime` is required and must be specified in CreateNocashStockResponse")
	}
	toSerialize["create_time"] = o.CreateTime
	return json.Marshal(toSerialize)
}

func (o CreateNocashStockResponse) String() string {
	var ret string
	if o.StockId == nil {
		ret += "StockId:<nil>, "
	} else {
	...
	return fmt.Sprintf("CreateNocashStockResponse{%s}", ret)
}

func (o CreateNocashStockResponse) Clone() *CreateNocashStockResponse {
	ret := CreateNocashStockResponse{}
...
// DiscountCutMsg
type DiscountCutMsg struct {
	// 优惠使用门槛，单位分
	TransactionMinimum *int64      `json:"transaction_minimum"`
	RandomCutMessage   []RandomCut `json:"random_cut_message,omitempty"`
	//
	DiscountMessage *DiscountMsg `json:"discount_message,omitempty"`
	// 固定加减金额，单位分
	FixCutAmount *int64 `json:"fix_cut_amount,omitempty"`
}

func (o DiscountCutMsg) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.TransactionMinimum == nil {
		return nil, fmt.Errorf("field `TransactionMinimum` is required and must be specified in DiscountCutMsg")
	}
	toSerialize["transaction_minimum"] = o.TransactionMinimum

	if o.RandomCutMessage != nil {
		toSerialize["random_cut_message"] = o.RandomCutMessage
	}

	if o.DiscountMessage != nil {
		toSerialize["discount_message"] = o.DiscountMessage
	}

	if o.FixCutAmount != nil {
		toSerialize["fix_cut_amount"] = o.FixCutAmount
	}
	return json.Marshal(toSerialize)
}

func (o DiscountCutMsg) String() string {
	var ret string
	if o.TransactionMinimum == nil {
	...
	ret += fmt.Sprintf("RandomCutMessage:%v, ", o.RandomCutMessage)

	ret += fmt.Sprintf("DiscountMessage:%v, ", o.DiscountMessage)

	if o.FixCutAmount == nil {
		ret += "FixCutAmount:<nil>"
	} else {
		ret += fmt.Sprintf("FixCutAmount:%v", *o.FixCutAmount)
	}

	return fmt.Sprintf("DiscountCutMsg{%s}", ret)
}

func (o DiscountCutMsg) Clone() *DiscountCutMsg {
	ret := DiscountCutMsg{}
	...
	if o.RandomCutMessage != nil {
		ret.RandomCutMessage = make([]RandomCut, len(o.RandomCutMessage))
		for i, item := range o.RandomCutMessage {
			ret.RandomCutMessage[i] = *item.Clone()
		}
	}

	if o.DiscountMessage != nil {
		ret.DiscountMessage = o.DiscountMessage.Clone()
	}

	if o.FixCutAmount != nil {
		ret.FixCutAmount = new(int64)
		*ret.FixCutAmount = *o.FixCutAmount
	}
...
type DiscountMsg struct {
	// 最高折扣金额，单位分
	DiscountAmountMax *int64 `json:"discount_amount_max"`
	// 折扣百分比，例如88-八八折
...
func (o DiscountMsg) MarshalJSON() ([]byte, error) {
	...
	if o.DiscountAmountMax == nil {
		return nil, fmt.Errorf("field `DiscountAmountMax` is required and must be specified in DiscountMsg")
	}
	toSerialize["discount_amount_max"] = o.DiscountAmountMax

	if o.DiscountPercent == nil {
		return nil, fmt.Errorf("field `DiscountPercent` is required and must be specified in DiscountMsg")
	}
...
func (o DiscountMsg) String() string {
	var ret string
	if o.DiscountAmountMax == nil {
		ret += "DiscountAmountMax:<nil>, "
	} else {
		ret += fmt.Sprintf("DiscountAmountMax:%v, ", *o.DiscountAmountMax)
	}
...
func (o DiscountMsg) Clone() *DiscountMsg {
	...
	if o.DiscountAmountMax != nil {
		ret.DiscountAmountMax = new(int64)
		*ret.DiscountAmountMax = *o.DiscountAmountMax
	}
...
type GetPlatformFavorRequest struct {
	// 批次id
	StockId *string `json:"stock_id"`
	// 创建批次的商户id
	StockCreatorMchid *string `json:"stock_creator_mchid"`
...
func (o GetPlatformFavorRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in GetPlatformFavorRequest")
	}
	toSerialize["stock_id"] = o.StockId

	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in GetPlatformFavorRequest")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid
	return json.Marshal(toSerialize)
}

func (o GetPlatformFavorRequest) String() string {
	var ret string
	if o.StockId == nil {
		ret += "StockId:<nil>, "
	} else {
	...
	return fmt.Sprintf("GetPlatformFavorRequest{%s}", ret)
}

func (o GetPlatformFavorRequest) Clone() *GetPlatformFavorRequest {
	ret := GetPlatformFavorRequest{}
...
type ModifyAvailableMerchantsRequest struct {
	// 批次创建方商户号
	StockCreatorMchid *string `json:"stock_creator_mchid"`
	// 批次号
	StockId *string `json:"stock_id"`
...
func (o ModifyAvailableMerchantsRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in ModifyAvailableMerchantsRequest")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyAvailableMerchantsRequest")
	}
	toSerialize["stock_id"] = o.StockId
...
func (o ModifyAvailableMerchantsRequest) String() string {
	var ret string
	if o.StockCreatorMchid == nil {
		ret += "StockCreatorMchid:<nil>, "
	} else {
	...
	return fmt.Sprintf("ModifyAvailableMerchantsRequest{%s}", ret)
}

func (o ModifyAvailableMerchantsRequest) Clone() *ModifyAvailableMerchantsRequest {
	ret := ModifyAvailableMerchantsRequest{}
...
type ModifyAvailableSingleitemsRequest struct {
	// 批次创建方商户号
	StockCreatorMchid *string `json:"stock_creator_mchid"`
	// 批次号
	StockId *string `json:"stock_id"`
...
func (o ModifyAvailableSingleitemsRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in ModifyAvailableSingleitemsRequest")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyAvailableSingleitemsRequest")
	}
	toSerialize["stock_id"] = o.StockId
...
func (o ModifyAvailableSingleitemsRequest) String() string {
	var ret string
	if o.StockCreatorMchid == nil {
		ret += "StockCreatorMchid:<nil>, "
	} else {
	...
	return fmt.Sprintf("ModifyAvailableSingleitemsRequest{%s}", ret)
}

func (o ModifyAvailableSingleitemsRequest) Clone() *ModifyAvailableSingleitemsRequest {
	ret := ModifyAvailableSingleitemsRequest{}
...
func (o ModifyBudgetRequest) MarshalJSON() ([]byte, error) {
	...
	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in ModifyBudgetRequest")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid
	...
	if o.TargetMaxAmount == nil {
		return nil, fmt.Errorf("field `TargetMaxAmount` is required and must be specified in ModifyBudgetRequest")
	}
	toSerialize["target_max_amount"] = o.TargetMaxAmount

	if o.CurrentMaxAmount == nil {
		return nil, fmt.Errorf("field `CurrentMaxAmount` is required and must be specified in ModifyBudgetRequest")
	}
...
func (o ModifyStockBody) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in ModifyStockBody")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid

	if o.MaxAmountByDay == nil {
		return nil, fmt.Errorf("field `MaxAmountByDay` is required and must be specified in ModifyStockBody")
	}
	toSerialize["max_amount_by_day"] = o.MaxAmountByDay
	return json.Marshal(toSerialize)
}

func (o ModifyStockBody) String() string {
	var ret string
	if o.StockCreatorMchid == nil {
		ret += "StockCreatorMchid:<nil>, "
	} else {
	...
	return fmt.Sprintf("ModifyStockBody{%s}", ret)
}

func (o ModifyStockBody) Clone() *ModifyStockBody {
	ret := ModifyStockBody{}
...
func (o ModifyStockRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockCreatorMchid == nil {
		return nil, fmt.Errorf("field `StockCreatorMchid` is required and must be specified in ModifyStockRequest")
	}
	toSerialize["stock_creator_mchid"] = o.StockCreatorMchid

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyStockRequest")
	}
	toSerialize["stock_id"] = o.StockId

	if o.MaxAmountByDay == nil {
		return nil, fmt.Errorf("field `MaxAmountByDay` is required and must be specified in ModifyStockRequest")
	}
	toSerialize["max_amount_by_day"] = o.MaxAmountByDay
	return json.Marshal(toSerialize)
}

func (o ModifyStockRequest) String() string {
	var ret string
	if o.StockCreatorMchid == nil {
		ret += "StockCreatorMchid:<nil>, "
	} else {
	...
	return fmt.Sprintf("ModifyStockRequest{%s}", ret)
}

func (o ModifyStockRequest) Clone() *ModifyStockRequest {
	ret := ModifyStockRequest{}
...
func (o ModifyStockResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.MaxAmountByDay == nil {
		return nil, fmt.Errorf("field `MaxAmountByDay` is required and must be specified in ModifyStockResponse")
	}
	toSerialize["max_amount_by_day"] = o.MaxAmountByDay

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in ModifyStockResponse")
	}
	toSerialize["stock_id"] = o.StockId
	return json.Marshal(toSerialize)
}

func (o ModifyStockResponse) String() string {
	var ret string
	if o.MaxAmountByDay == nil {
		ret += "MaxAmountByDay:<nil>, "
	} else {
	...
	return fmt.Sprintf("ModifyStockResponse{%s}", ret)
}

func (o ModifyStockResponse) Clone() *ModifyStockResponse {
	ret := ModifyStockResponse{}
...
type PlatformFavorAvailableTime struct {
	// 立减金优惠核销有效期开始时间
	AvailableBeginTime *string `json:"available_begin_time"`
	// 立减金优惠核销有效期结束时间
	AvailableEndTime *string `json:"available_end_time"`
...
func (o PlatformFavorAvailableTime) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.AvailableBeginTime == nil {
		return nil, fmt.Errorf("field `AvailableBeginTime` is required and must be specified in PlatformFavorAvailableTime")
	}
	toSerialize["available_begin_time"] = o.AvailableBeginTime

	if o.AvailableEndTime == nil {
		return nil, fmt.Errorf("field `AvailableEndTime` is required and must be specified in PlatformFavorAvailableTime")
	}
	toSerialize["available_end_time"] = o.AvailableEndTime
	return json.Marshal(toSerialize)
}

func (o PlatformFavorAvailableTime) String() string {
	var ret string
	if o.AvailableBeginTime == nil {
		ret += "AvailableBeginTime:<nil>, "
	} else {
	...
	return fmt.Sprintf("PlatformFavorAvailableTime{%s}", ret)
}

func (o PlatformFavorAvailableTime) Clone() *PlatformFavorAvailableTime {
	ret := PlatformFavorAvailableTime{}
...
type PlatformFavorCreateRequest struct {
	// 批次归属商户号
	BelongMerchant *string `json:"belong_merchant"`
	//
	SendRule *PlatformFavorSendRule `json:"send_rule"`
	//
	UseRule *PlatformFavorUseRule `json:"use_rule"`
	//
	DisplayPattern *PlatformFavorDisplayPattern `json:"display_pattern,omitempty"`
	// 商户创建批次凭据号（格式：商户id+日期+流水号），商户侧需保持唯一性
	OutRequestNo *string `json:"out_request_no"`
}

func (o PlatformFavorCreateRequest) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.BelongMerchant == nil {
		return nil, fmt.Errorf("field `BelongMerchant` is required and must be specified in PlatformFavorCreateRequest")
	}
	toSerialize["belong_merchant"] = o.BelongMerchant

	if o.SendRule == nil {
		return nil, fmt.Errorf("field `SendRule` is required and must be specified in PlatformFavorCreateRequest")
	}
	toSerialize["send_rule"] = o.SendRule

	if o.UseRule == nil {
		return nil, fmt.Errorf("field `UseRule` is required and must be specified in PlatformFavorCreateRequest")
	}
	toSerialize["use_rule"] = o.UseRule

	if o.DisplayPattern != nil {
		toSerialize["display_pattern"] = o.DisplayPattern
	}

	if o.OutRequestNo == nil {
		return nil, fmt.Errorf("field `OutRequestNo` is required and must be specified in PlatformFavorCreateRequest")
	}
	toSerialize["out_request_no"] = o.OutRequestNo
	return json.Marshal(toSerialize)
}

func (o PlatformFavorCreateRequest) String() string {
	var ret string
	if o.BelongMerchant == nil {
		ret += "BelongMerchant:<nil>, "
	} else {
	...
	ret += fmt.Sprintf("SendRule:%v, ", o.SendRule)

	ret += fmt.Sprintf("UseRule:%v, ", o.UseRule)

	ret += fmt.Sprintf("DisplayPattern:%v, ", o.DisplayPattern)
	...
	return fmt.Sprintf("PlatformFavorCreateRequest{%s}", ret)
}

func (o PlatformFavorCreateRequest) Clone() *PlatformFavorCreateRequest {
	ret := PlatformFavorCreateRequest{}
	...
	if o.SendRule != nil {
		ret.SendRule = o.SendRule.Clone()
	}

	if o.UseRule != nil {
		ret.UseRule = o.UseRule.Clone()
	}

	if o.DisplayPattern != nil {
		ret.DisplayPattern = o.DisplayPattern.Clone()
	}
...
type CreatePlatformFavorRequest PlatformFavorCreateRequest

func (o CreatePlatformFavorRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(PlatformFavorCreateRequest(o))
}

func (o CreatePlatformFavorRequest) String() string {
	return "CreatePlatformFavorRequest" + strings.TrimPrefix(PlatformFavorCreateRequest(o).String(), "PlatformFavorCreateRequest")
}

func (o CreatePlatformFavorRequest) Clone() *CreatePlatformFavorRequest {
	clone := PlatformFavorCreateRequest(o).Clone()
	return (*CreatePlatformFavorRequest)(clone)
}

// PlatformFavorDisplayPattern
type PlatformFavorDisplayPattern struct {
	// 展示在券详情页面的说明文本
	Description *string `json:"description,omitempty"`
}

func (o PlatformFavorDisplayPattern) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}
...
func (o PlatformFavorDisplayPattern) String() string {
	var ret string
	if o.Description == nil {
		ret += "Description:<nil>"
	} else {
	...
	return fmt.Sprintf("PlatformFavorDisplayPattern{%s}", ret)
}

func (o PlatformFavorDisplayPattern) Clone() *PlatformFavorDisplayPattern {
	ret := PlatformFavorDisplayPattern{}
...
type PlatformFavorSendRule struct {
	// 批次可发放券的总张数
	...
	// 立减金批次预算的扣款方式
	DeductBalanceMethod *DeductBalanceMethod `json:"deduct_balance_method"`
}

func (o PlatformFavorSendRule) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.MaxCoupons == nil {
		return nil, fmt.Errorf("field `MaxCoupons` is required and must be specified in PlatformFavorSendRule")
	}
	toSerialize["max_coupons"] = o.MaxCoupons

	if o.MaxAmount == nil {
		return nil, fmt.Errorf("field `MaxAmount` is required and must be specified in PlatformFavorSendRule")
	}
	toSerialize["max_amount"] = o.MaxAmount
	...
	if o.MaxCouponsPerUser == nil {
		return nil, fmt.Errorf("field `MaxCouponsPerUser` is required and must be specified in PlatformFavorSendRule")
	}
	...
	if o.DeductBalanceMethod == nil {
		return nil, fmt.Errorf("field `DeductBalanceMethod` is required and must be specified in PlatformFavorSendRule")
	}
	toSerialize["deduct_balance_method"] = o.DeductBalanceMethod
	return json.Marshal(toSerialize)
}

func (o PlatformFavorSendRule) String() string {
	var ret string
	if o.MaxCoupons == nil {
		ret += "MaxCoupons:<nil>, "
	} else {
	...
	if o.DeductBalanceMethod == nil {
		ret += "DeductBalanceMethod:<nil>"
	} else {
		ret += fmt.Sprintf("DeductBalanceMethod:%v", *o.DeductBalanceMethod)
	}

	return fmt.Sprintf("PlatformFavorSendRule{%s}", ret)
}

func (o PlatformFavorSendRule) Clone() *PlatformFavorSendRule {
	ret := PlatformFavorSendRule{}
	...
	if o.DeductBalanceMethod != nil {
		ret.DeductBalanceMethod = new(DeductBalanceMethod)
		*ret.DeductBalanceMethod = *o.DeductBalanceMethod
	}
...
type PlatformFavorStockEntity struct {
	// 立减金批次的主键，唯一定义此资源的标识
	StockId *string `json:"stock_id"`
	// 立减金批次创建成功时间
	CreateTime *string `json:"create_time"`
	// 立减金批次展示名称，按照平台规则固定为x元立减金
	StockName *string `json:"stock_name"`
	// 批次归属商户id
	BelongMerchant *string `json:"belong_merchant"`
	//
	...
	DisplayPattern *PlatformFavorDisplayPattern `json:"display_pattern,omitempty"`
	// 批次状态
	StockStatus *PlatformFavorStockStatus `json:"stock_status"`
	// 批次激活时间
...
func (o PlatformFavorStockEntity) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.StockId == nil {
		return nil, fmt.Errorf("field `StockId` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["stock_id"] = o.StockId

	if o.CreateTime == nil {
		return nil, fmt.Errorf("field `CreateTime` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["create_time"] = o.CreateTime

	if o.StockName == nil {
		return nil, fmt.Errorf("field `StockName` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["stock_name"] = o.StockName

	if o.BelongMerchant == nil {
		return nil, fmt.Errorf("field `BelongMerchant` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["belong_merchant"] = o.BelongMerchant

	if o.SendRule == nil {
		return nil, fmt.Errorf("field `SendRule` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["send_rule"] = o.SendRule

	if o.UseRule == nil {
		return nil, fmt.Errorf("field `UseRule` is required and must be specified in PlatformFavorStockEntity")
	}
	toSerialize["use_rule"] = o.UseRule
	...
	if o.StockStatus == nil {
		return nil, fmt.Errorf("field `StockStatus` is required and must be specified in PlatformFavorStockEntity")
	}
	...
	if o.StatisticalData != nil {
		toSerialize["statistical_data"] = o.StatisticalData
	}
...
func (o PlatformFavorStockEntity) String() string {
	var ret string
	if o.StockId == nil {
		ret += "StockId:<nil>, "
	} else {
	...
	if o.StockStatus == nil {
		...
		ret += fmt.Sprintf("StockStatus:%v, ", *o.StockStatus)
	}

	if o.ActiveTime == nil {
		ret += "ActiveTime:<nil>, "
	} else {
		ret += fmt.Sprintf("ActiveTime:%v, ", *o.ActiveTime)
	}
	...
	ret += fmt.Sprintf("StatisticalData:%v, ", o.StatisticalData)
	...
	return fmt.Sprintf("PlatformFavorStockEntity{%s}", ret)
}

func (o PlatformFavorStockEntity) Clone() *PlatformFavorStockEntity {
	ret := PlatformFavorStockEntity{}
	...
	if o.StockStatus != nil {
		ret.StockStatus = new(PlatformFavorStockStatus)
		*ret.StockStatus = *o.StockStatus
	}

	if o.ActiveTime != nil {
		ret.ActiveTime = new(string)
		*ret.ActiveTime = *o.ActiveTime
	}
	...
	if o.StatisticalData != nil {
		ret.StatisticalData = o.StatisticalData.Clone()
	}
...
type PlatformFavorUseRule struct {
	// 日期区间内可以使用优惠
	AvailableTime *PlatformFavorAvailableTime `json:"available_time"`
	// 券面额，单位分
	CouponAmount *int64 `json:"coupon_amount"`
	// 使用券金额门槛，单位分
	TransactionMinimum *int64 `json:"transaction_minimum,omitempty"`
...
func (o PlatformFavorUseRule) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.AvailableTime == nil {
		return nil, fmt.Errorf("field `AvailableTime` is required and must be specified in PlatformFavorUseRule")
	}
	toSerialize["available_time"] = o.AvailableTime

	if o.CouponAmount == nil {
		return nil, fmt.Errorf("field `CouponAmount` is required and must be specified in PlatformFavorUseRule")
	}
	toSerialize["coupon_amount"] = o.CouponAmount
...
func (o PlatformFavorUseRule) String() string {
	var ret string
	...
	return fmt.Sprintf("PlatformFavorUseRule{%s}", ret)
}

func (o PlatformFavorUseRule) Clone() *PlatformFavorUseRule {
	ret := PlatformFavorUseRule{}

	if o.AvailableTime != nil {
		ret.AvailableTime = o.AvailableTime.Clone()
	}
...
type RandomCut struct {
	// 减价规则预算，单位分
	RuleMaxAmount *int64 `json:"rule_max_amount"`
	// 最小减价金额，单位分
	CutAmountBegin *int64 `json:"cut_amount_begin"`
	// 最大减价金额，单位分
	CutAmountEnd *int64 `json:"cut_amount_end,omitempty"`
}

func (o RandomCut) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.RuleMaxAmount == nil {
		return nil, fmt.Errorf("field `RuleMaxAmount` is required and must be specified in RandomCut")
	}
	toSerialize["rule_max_amount"] = o.RuleMaxAmount

	if o.CutAmountBegin == nil {
		return nil, fmt.Errorf("field `CutAmountBegin` is required and must be specified in RandomCut")
	}
	toSerialize["cut_amount_begin"] = o.CutAmountBegin

	if o.CutAmountEnd != nil {
		toSerialize["cut_amount_end"] = o.CutAmountEnd
	}
	return json.Marshal(toSerialize)
}

func (o RandomCut) String() string {
	var ret string
	if o.RuleMaxAmount == nil {
		ret += "RuleMaxAmount:<nil>, "
	} else {
		ret += fmt.Sprintf("RuleMaxAmount:%v, ", *o.RuleMaxAmount)
	}

	if o.CutAmountBegin == nil {
		ret += "CutAmountBegin:<nil>, "
	} else {
		ret += fmt.Sprintf("CutAmountBegin:%v, ", *o.CutAmountBegin)
	}

	if o.CutAmountEnd == nil {
		ret += "CutAmountEnd:<nil>"
	} else {
		ret += fmt.Sprintf("CutAmountEnd:%v", *o.CutAmountEnd)
	}

	return fmt.Sprintf("RandomCut{%s}", ret)
}

func (o RandomCut) Clone() *RandomCut {
	ret := RandomCut{}

	if o.RuleMaxAmount != nil {
		ret.RuleMaxAmount = new(int64)
		*ret.RuleMaxAmount = *o.RuleMaxAmount
	}

	if o.CutAmountBegin != nil {
		ret.CutAmountBegin = new(int64)
		*ret.CutAmountBegin = *o.CutAmountBegin
	}

	if o.CutAmountEnd != nil {
		ret.CutAmountEnd = new(int64)
		*ret.CutAmountEnd = *o.CutAmountEnd
	}
...
type StatisticalData struct {
	// 批次已发放券张数
	SendCouponsCount *int64 `json:"send_coupons_count,omitempty"`
	// 批次已核销券张数
	ConsumeCouponsCount *int64 `json:"consume_coupons_count,omitempty"`
}

func (o StatisticalData) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.SendCouponsCount != nil {
		toSerialize["send_coupons_count"] = o.SendCouponsCount
	}

	if o.ConsumeCouponsCount != nil {
		toSerialize["consume_coupons_count"] = o.ConsumeCouponsCount
	}
	return json.Marshal(toSerialize)
}

func (o StatisticalData) String() string {
	var ret string
	if o.SendCouponsCount == nil {
		ret += "SendCouponsCount:<nil>, "
	} else {
		ret += fmt.Sprintf("SendCouponsCount:%v, ", *o.SendCouponsCount)
	}

	if o.ConsumeCouponsCount == nil {
		ret += "ConsumeCouponsCount:<nil>"
	} else {
		ret += fmt.Sprintf("ConsumeCouponsCount:%v", *o.ConsumeCouponsCount)
	}

	return fmt.Sprintf("StatisticalData{%s}", ret)
}

func (o StatisticalData) Clone() *StatisticalData {
	ret := StatisticalData{}

	if o.SendCouponsCount != nil {
		ret.SendCouponsCount = new(int64)
		*ret.SendCouponsCount = *o.SendCouponsCount
	}

	if o.ConsumeCouponsCount != nil {
		ret.ConsumeCouponsCount = new(int64)
		*ret.ConsumeCouponsCount = *o.ConsumeCouponsCount
	}
...
type StockDownloadRefundFlowResponse struct {
	// 流水文件下载链接，30s内有效
	Url *string `json:"url"`
	// 文件内容的哈希值，防止篡改
...
func (o StockDownloadRefundFlowResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.Url == nil {
		return nil, fmt.Errorf("field `Url` is required and must be specified in StockDownloadRefundFlowResponse")
	}
	toSerialize["url"] = o.Url

	if o.HashValue == nil {
		return nil, fmt.Errorf("field `HashValue` is required and must be specified in StockDownloadRefundFlowResponse")
	}
	toSerialize["hash_value"] = o.HashValue

	if o.HashType == nil {
		return nil, fmt.Errorf("field `HashType` is required and must be specified in StockDownloadRefundFlowResponse")
	}
	toSerialize["hash_type"] = o.HashType
	return json.Marshal(toSerialize)
}

func (o StockDownloadRefundFlowResponse) String() string {
	var ret string
	if o.Url == nil {
		ret += "Url:<nil>, "
	} else {
	...
	return fmt.Sprintf("StockDownloadRefundFlowResponse{%s}", ret)
}

func (o StockDownloadRefundFlowResponse) Clone() *StockDownloadRefundFlowResponse {
	ret := StockDownloadRefundFlowResponse{}
...
type StockDownloadUseFlowResponse struct {
	// 流水文件下载链接，30s内有效
	Url *string `json:"url"`
	// 文件内容的哈希值，防止篡改
	HashValue *string `json:"hash_value"`
...
func (o StockDownloadUseFlowResponse) MarshalJSON() ([]byte, error) {
	toSerialize := map[string]interface{}{}

	if o.Url == nil {
		return nil, fmt.Errorf("field `Url` is required and must be specified in StockDownloadUseFlowResponse")
	}
	toSerialize["url"] = o.Url

	if o.HashValue == nil {
		return nil, fmt.Errorf("field `HashValue` is required and must be specified in StockDownloadUseFlowResponse")
	}
	toSerialize["hash_value"] = o.HashValue

	if o.HashType == nil {
		return nil, fmt.Errorf("field `HashType` is required and must be specified in StockDownloadUseFlowResponse")
	}
	toSerialize["hash_type"] = o.HashType
	return json.Marshal(toSerialize)
}

func (o StockDownloadUseFlowResponse) String() string {
	var ret string
	if o.Url == nil {
		ret += "Url:<nil>, "
	} else {
	...
	return fmt.Sprintf("StockDownloadUseFlowResponse{%s}", ret)
}

func (o StockDownloadUseFlowResponse) Clone() *StockDownloadUseFlowResponse {
	ret := StockDownloadUseFlowResponse{}
